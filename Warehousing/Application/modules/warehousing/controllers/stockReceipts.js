    ...
    angular.module('warehousing').controller('stockReceipts', function ($scope, $proxy, $location) {
        ...
        $scope.gridOptions = {
            ...
            columnDefs: [
                ...
                { field: 'CreatedDate', displayName: 'Created Date', width: '*', minWidth: 150, cellFilter: 'date: "dd/MM/yyyy"'},
                { field: 'Warehouse.Name', displayName: 'Warehouse', width: '*', minWidth: 150 },                
                { field: 'TotalCost', displayName: 'Total Cost', width: '*', minWidth: 150, cellFilter: 'number: 2', cellClass: 'number'},
                { field: 'Id', displayName: '', width: '*', minWidth: 100, cellTemplate:
