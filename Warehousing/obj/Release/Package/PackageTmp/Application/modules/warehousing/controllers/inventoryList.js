define([], function () {
    angular.module('warehousing').controller('inventoryList', function ($scope, $proxy) {
        ...
        function populateColumns() {
            $scope.gridOptions.columnDefs = [{ field: 'ProductName', displayName: 'Product', width: '25%' },
                { field: 'ProductNo', displayName: 'Number', width: '15%' },
                { field: 'CategoryName', displayName: 'Category', width: '15%' }];
